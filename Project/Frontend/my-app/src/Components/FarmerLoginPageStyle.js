...
// note guys : install this library for style-components -> npm install styled-components
...
export const GhostButton = styled(Button)`
  ...
  border-color: #4CAF50; /* Green border for the ghost button */
`;
...
export const Overlay = styled.div`
  ...
  background: -webkit-linear-gradient(to right, #4CAF50, #388E3C); /* Lighter green to darker green gradient */
